...
% Override \lstinline to use only black color
\let\oldlstinline\lstinline
\renewcommand{\lstinline}[2][]{\oldlstinline[basicstyle=\ttfamily\color{black},identifierstyle=\color{black},commentstyle=\color{black},stringstyle=\color{black},keywordstyle=\color{black},numberstyle=\color{black},#1]{#2}}
\fi
