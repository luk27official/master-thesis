...
\def\inline{\lstinline[basicstyle=\footnotesize\bfseries\ttfamily\color{black}, keywordstyle={\bfseries\ttfamily\color{black}}, identifierstyle=\bfseries\ttfamily\color{black}, 
numberstyle=\color{black}, columns=fixed, basewidth=0.5em, fontadjust=true, tabsize=2, showstringspaces=false]}
\fi
