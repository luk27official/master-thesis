...
\lstinputlisting[language=JavaScript, caption={Example of Mol* code snippet from \inline|frontend/src/components/| \inline|MolstarComponent.ts| (modified).}, label={lst:molstar-code}]{code/molstar-example.tsx}
