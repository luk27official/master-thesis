...
An overview of the service architecture can be seen in Figure~\ref{fig:architecture}. 

\xxx{TODO: complete this, add used technology stack for each of the services?}
