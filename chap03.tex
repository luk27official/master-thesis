...
\lstinputlisting[language=JavaScript, caption={Example of Mol* code snippet from \lstinline|frontend/src/components/| \lstinline|MolstarComponent.ts| (modified).}, label={lst:molstar-code}]{code/molstar-example.tsx}
