...
\lstinputlisting[language=JavaScript, caption={Code snippet from \inline|frontend/src/components/MolstarComponent.ts| (modified).}, label={lst:molstar-code}]{code/molstar-example.tsx}
